                                        ...
                                        <div class="dash__pad-1">
                                            ...
                                            <ul class="dash__f-list">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/shopkeeper_add_product">Add product</a></li>
                                                <li>

                                                    <a href="${pageContext.request.contextPath}/shopkeeper/add_promotion">Add promotion</a></li>
                                                <li>

                                                    <a class="dash-active" href="${pageContext.request.contextPath}/shopkeeper/update_price">Update price</a></li>
                                                <li>
                                            ...
                                            <form class="dash-edit-p">
                                                ...
                                                <div class="gl-inline">
                                                    <div class="u-s-m-b-30">
                                                        ...
                                                        <label class="gl-label" for="reg-oprice">OLD PRICE *</label>

                                                        <input class="input-text input-text--primary-style" type="text" id="reg-oprice" placeholder="6000"></div>
                                                    <div class="u-s-m-b-30">

                                                        <label class="gl-label" for="reg-nprice">NEW PRICE *</label>
                                                        <input class="input-text input-text--primary-style" type="text" id="reg-nprice" placeholder="100"></div>
                                                </div>                                    
                                                <br><button class="btn btn--e-brand-b-2" type="submit">UPDATE</button>
                                            </form>              
                                        </div>
                                    </div>
                                </div>
