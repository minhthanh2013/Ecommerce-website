                                        ...
                                        <div class="dash__pad-1">
                                            ...
                                            <ul class="dash__f-list">
                                                ...
                                                <li>
                                                    ...
                                                    <a class="dash-active" href="${pageContext.request.contextPath}/shopkeeper/sales_diary">Sales diary</a></li>
                                                <li>
                                ...
                                <div class="col-lg-9 col-md-12">
                                    <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                        <div class="dash__pad-2">
                                            <h1 class="dash__h1 u-s-m-b-14">Sales Diary</h1>
                                            <span class="dash__text u-s-m-b-30">Manage your sale diary!</span>
