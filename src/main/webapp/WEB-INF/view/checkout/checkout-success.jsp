                    ...
                    <div class="dash">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8" style="margin-left: 15%; margin-right: 15%;">
                                    <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                        <div class="dash__pad-2">
                                            <h1 class="dash__h1 u-s-m-b-30" align="center"><i class="far fa-check-circle" style="font-size:70px;color:orangered"></i>
                                                <br><br><b>ORDER SUCCESSFULLY PLACED</b>
                                            </h1>
                    ...
                    <div class="modal-body">
                        <form class="d-modal__form">
                            <div class="u-s-m-b-15">
                                ...
                                <a class="d_modal__link" href="${pageContext.request.contextPath}/dashboard/manage_order">Ludus Privacy Policy</a>
                            </div>
