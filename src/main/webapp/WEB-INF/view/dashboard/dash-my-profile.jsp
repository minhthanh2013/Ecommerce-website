                            ...
                            <div class="breadcrumb__wrap">
                                <ul class="breadcrumb__list">
                                    ...
                                    <li class="is-marked">
                                        ...
                                        <a href="${pageContext.request.contextPath}/dashboard/my_profile">My Account</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="dash__pad-1">
                                            ...
                                            <ul class="dash__f-list">
                                                ...
                                                <li>
                                                    ...
                                                    <a class="dash-active" href="${pageContext.request.contextPath}/dashboard/my_profile">My Profile</a></li>
                                                <li>
                                        ...
                                        <div class="dash__pad-2">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    ...
                                                    <span class="dash__text">${user_full_name}</span>
                                                </div>
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    <h2 class="dash__h2 u-s-m-b-8">E-mail</h2>

                                                    <span class="dash__text">${user_email}</span>
                                                ...
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    ...
                                                    <span class="dash__text">${user_phone}</span>
                                                    <div class="dash__link dash__link--secondary">
                                                ...
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    ...
                                                    <span class="dash__text">${user_dob}</span>
                                                </div>
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    <h2 class="dash__h2 u-s-m-b-8">Gender</h2>

                                                    <span class="dash__text">${user_gender}</span>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="u-s-m-b-16">
                                                        ...
                                                        <a class="dash__custom-link btn--e-transparent-brand-b-2" href="${pageContext.request.contextPath}/dashboard/edit_profile">Edit Profile</a></div>
                                                    <div>
                    ...
                    <div class="modal-body">
                        <form class="d-modal__form">
                            <div class="u-s-m-b-15">
                                ...
                                <a class="d_modal__link" href="${pageContext.request.contextPath}/dashboard/my_profile">Ludus Privacy Policy</a>
                            </div>
