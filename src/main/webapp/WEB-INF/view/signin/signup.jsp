                            ...
                            <div class="col-lg-6 col-md-8 u-s-m-b-30">
                                <div class="l-f-o">
                                    <div class="l-f-o__pad-box">
                                        ...
                                        <form:form action="${pageContext.request.contextPath}/register/processRegistrationForm" modelAttribute="CustomerUser" class="l-f-o__form">
                                            ...
                                            <div class="u-s-m-b-30">
                                                ...
                                                <form:input class="input-text input-text--primary-style" type="text" id="reg-fname" placeholder="Full name" path="fullName"/>
                                            </div>
                                            <div class="u-s-m-b-30">

                                                <label class="gl-label" for="reg-lname">PHONE NUMBER *</label>

                                                <form:input class="input-text input-text--primary-style" type="number" id="reg-lname" placeholder="Phone number" path="phone"/>
                                               </div>
                                            <div class="gl-inline">
                                                <div class="u-s-m-b-30">
                                                ...
                                                <div class="u-s-m-b-30">
                                                    ...
                                                    <form:select class="select-box select-box--primary-style u-w-100" id="gender" path="sex">
                                            ...
                                            <div class="u-s-m-b-30">
                                                ...
                                                <form:input class="input-text input-text--primary-style" type="text" id="reg-email" placeholder="Enter E-mail" path="email"/></div>
                                            <div class="u-s-m-b-30">

                                                <label class="gl-label" for="reg-password">PASSWORD *</label>

                                                <form:input class="input-text input-text--primary-style" type="password" id="reg-password" placeholder="Enter Password" path="password"/></div>
