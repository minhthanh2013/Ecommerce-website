                            ...
                            <div class="col-lg-6 col-md-8 u-s-m-b-30">
                                <div class="l-f-o">
                                    <div class="l-f-o__pad-box">
                                        ...
                                        <form:form action="${pageContext.request.contextPath}/authenticateTheUser" method="POST" class="form-horizontal l-f-o__form">
<%--                                        <form class="l-f-o__form">--%>
                                            <div class="gl-s-api">
                                                ...
                                                <div class="u-s-m-b-30">
                                                    ...
                                                    <input class="input-text input-text--primary-style" type="text" id="login-email" placeholder="Enter E-mail" name="username"></div>
                                                <div class="u-s-m-b-30">
