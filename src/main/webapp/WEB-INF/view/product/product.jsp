...
<head>
    ...
    <script>
        window.onload = function () {
            let item = document.getElementsByClassName("menu-item-left")
            for (let i = 0; i < item.length; i++) {
                let split1 = item[i].href.split("&")
                let split2 = split1[1].split("=")
                if (parseInt(split2[1]) === ${type1}) {
                    item[i].style.color = "#ff4500"
                }
            }
            let temp1 = document.getElementsByClassName("product-m__price")
            for (let i = 0; i < temp1.length; i++) {
                let x = parseInt(temp1[i].innerText)
...
<div class="preloader is-active">
    <div class="preloader__wrap">
        ...
        <img class="preloader__img" src="${pageContext.request.contextPath}/resources/images/preloader.png" alt="">
    </div>
</div>
                ...
                <div class="primary-nav">
                    ...
                    <form class="main-form" action="${pageContext.request.contextPath}/product" method="get">
                        ...
                        <input class="input-text input-text--border-radius input-text--style-1" type="text"
                               id="main-search" placeholder="Search" name="name">
                                            ...
                                            <div class="mega-menu-list">
                                                <ul>
                                                    <li class="js-active">
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/product?type=7"><i
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/product?type=11"><i
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/product?type=10"><i
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/product?page=0&type=1"><i
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/product?page=0&type=2"><i
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/product?page=0&type=3"><i
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/product?page=0&type=4"><i
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/product?page=0&type=6"><i
                                                                class="fas fa-heartbeat u-s-m-r-6"></i>
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/product?page=0&type=8"><i
                                                                class="fas fa-heartbeat u-s-m-r-6"></i>
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/product?page=0&type=9"><i
                                                                class="fas fa-heartbeat u-s-m-r-6"></i>
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/product?page=0&type=12"><i
                                                                class="fas fa-heartbeat u-s-m-r-6"></i>
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/product?page=0&type=13"><i
                                                                class="fas fa-heartbeat u-s-m-r-6"></i>
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/product?page=0&type=14"><i
                                                                class="fas fa-heartbeat u-s-m-r-6"></i>

                                                            <span>Moto Bike</span></a>
                                                        ...
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block"
                                                                     src="${pageContext.request.contextPath}/resources/images/banners/banner-mega-0.jpg"
                                                                     alt=""></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-6 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block"
                                                                     src="${pageContext.request.contextPath}/resources/images/banners/banner-mega-1.jpg"
                                                                     alt=""></a></div>
                                                    </div>
                                                    <div class="col-lg-6 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block"
                                                                     src="${pageContext.request.contextPath}/resources/images/banners/banner-mega-2.jpg"
                                                                     alt=""></a></div>
                                                    </div>
                                                </div>
                                                <!--====== End - Mega Menu Row ======-->
                                                    ...
                                                    <div class="col-lg-9 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block"
                                                                     src="${pageContext.request.contextPath}/resources/images/banners/banner-mega-3.jpg"
                                                                     alt=""></a></div>
                                                    </div>
                                                    <div class="col-lg-3 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block"
                                                                     src="${pageContext.request.contextPath}/resources/images/banners/banner-mega-4.jpg"
                                                                     alt=""></a></div>
                                                    </div>
                                                </div>
                                                <!--====== End - Mega Menu Row ======-->
                                                    ...
                                                    <div class="col-lg-4 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block"
                                                                     src="${pageContext.request.contextPath}/resources/images/banners/banner-mega-5.jpg"
                                                                     alt=""></a></div>
                                                    </div>
                                                    <div class="col-lg-4 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block"
                                                                     src="${pageContext.request.contextPath}/resources/images/banners/banner-mega-6.jpg"
                                                                     alt=""></a></div>
                                                    </div>
                                                    <div class="col-lg-4 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block"
                                                                     src="${pageContext.request.contextPath}/resources/images/banners/banner-mega-7.jpg"
                                                                     alt=""></a></div>
                                                    </div>
                                                </div>
                                                <!--====== End - Mega Menu Row ======-->
                                                    ...
                                                    <div class="col-lg-6 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block"
                                                                     src="${pageContext.request.contextPath}/resources/images/banners/banner-mega-8.jpg"
                                                                     alt=""></a></div>
                                                    </div>
                                                    <div class="col-lg-6 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block"
                                                                     src="${pageContext.request.contextPath}/resources/images/banners/banner-mega-9.jpg"
                                                                     alt=""></a></div>
                                                    </div>
                                                </div>
                                                <!--====== End - Mega Menu Row ======-->
                                    ...
                                    <div class="mini-cart">
                                        ...
                                        <div class="mini-product-stat">
                                            ...
                                            <div class="mini-action">
                                                ...
                                                <a class="mini-link btn--e-brand-b-2" href="${pageContext.request.contextPath}/checkout/">PROCEED TO
                                                    CHECKOUT</a>

                                                <a class="mini-link btn--e-transparent-secondary-b-2" href="${pageContext.request.contextPath}/cart/">VIEW
                                                    CART</a></div>
                                        </div>
                                ...
                                <div class="u-s-m-b-30">
                                    <div class="shop-w">
                                        ...
                                        <div class="shop-w__wrap collapse show" id="s-category">
                                            ...
                                            <c:forEach var="productType" items="${productTypeCungCaps}">
                                                <li>

                                                    <a href="${pageContext.request.contextPath}/product?page=0&type=${productType.idType}"
                                                       class="menu-item-left">${productType.nameType}</a>

                                                    <span class="category-list__text u-s-m-l-6">(${productType.amount})</span></li>
                                            </c:forEach>
                            ...
                            <div class="shop-p__toolbar u-s-m-b-30">
                                <c:if test="${param.name != null}">
                                    <div class="shop-p__meta-wrap u-s-m-b-60">
                                        ...
                                        <span class="shop-p__meta-text-1">FOUND ${productTypeList1.size()} RESULTS</span>
                                        <div class="shop-p__meta-text-2">

                                            <span>Related Searches:</span>

                                            <c:forEach var="type" items="${productTypeList1}">
                                                <a class="gl-tag btn--e-brand-shadow" href="#">${type.nameType}</a>
                                            </c:forEach>
                                    ...
                                    <form>
                                        <div class="tool-style__form-wrap">
                                            <div class="u-s-m-b-8"><select
                                                ...
                                                <option value="8" class="select-item">Show: 8</option>
                                                <option value="12" class="select-item"> Show: 12</option>
                                                <option value="16" class="select-item">Show: 16</option>
                                                <option value="28" class="select-item">Show: 28</option>
                                            </select></div>
                                            <div class="u-s-m-b-8"><select
                                                    class="select-box select-box--transparent-b-2">
                                        ...
                                        <div class="product-m">
                                            <div class="product-m__thumb">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block" href="${pageContext.request.contextPath}/product/product_detail?id=${product.idProduct}">
                                                    ...
                                                    <img class="aspect__img" src="${pageContext.request.contextPath}/resources/images/product/men/product6.jpg" alt=""></a>
                                            ...
                                            <div class="product-m__content">
                                                <div class="product-m__category">
                                                    <c:if test="${product.idType==1}">
                                                        <a href="${pageContext.request.contextPath}/product?type=${product.idType}">Bags</a>
                                                    </c:if>
                                                    <c:if test="${product.idType==2}">
                                                        <a href="${pageContext.request.contextPath}/product?type=${product.idType}">Beauty & Health</a>
                                                    </c:if>
                                                    <c:if test="${product.idType==3}">
                                                        <a href="${pageContext.request.contextPath}/product?type=${product.idType}">Bike</a>
                                                    </c:if>
                                                    <c:if test="${product.idType==4}">
                                                        <a href="${pageContext.request.contextPath}/product?type=${product.idType}">Book</a>
                                                    </c:if>
                                                    <c:if test="${product.idType==5}">
                                                        <a href="${pageContext.request.contextPath}/product?type=${product.idType}">Cars </a>
                                                    </c:if>
                                                    <c:if test="${product.idType==6}">
                                                        <a href="${pageContext.request.contextPath}/product?type=${product.idType}">Decor</a>
                                                    </c:if>
                                                    <c:if test="${product.idType==7}">
                                                        <a href="${pageContext.request.contextPath}/product?type=${product.idType}">Electronics</a>
                                                    </c:if>
                                                    <c:if test="${product.idType==8}">
                                                        <a href="${pageContext.request.contextPath}/product?type=${product.idType}">Food</a>
                                                    </c:if>
                                                    <c:if test="${product.idType==9}">
                                                        <a href="${pageContext.request.contextPath}/product?type=${product.idType}">Game </a>
                                                    </c:if>
                                                    <c:if test="${product.idType==10}">
                                                        <a href="${pageContext.request.contextPath}/product?type=${product.idType}">Men Clothing</a>
                                                    </c:if>
                                                    <c:if test="${product.idType==11}">
                                                        <a href="${pageContext.request.contextPath}/product?type=${product.idType}">Women Clothing</a>
                                                    </c:if>
                                                    <c:if test="${product.idType==12}">
                                                        <a href="${pageContext.request.contextPath}/product?type=${product.idType}">Sports </a>
                                                    </c:if>
                                                    <c:if test="${product.idType==13}">
                                                        <a href="${pageContext.request.contextPath}/product?type=${product.idType}">Toys </a>
                                                    </c:if>
                                                    <c:if test="${product.idType==14}">
                                                        <a href="${pageContext.request.contextPath}/product?type=${product.idType}">Moto Bike</a>
                                                    </c:if>

                                                </div>
                                                <div class="product-m__name">

                                                    <a href="${pageContext.request.contextPath}/product/product_detail?id=${product.idProduct}">${product.name}</a></div>
                                ...
                                <ul class="shop-p__pagination">
                                    <c:forEach var="page1" items="${productListSize}">
                                        <c:if test="${param.page == page1}">
                                            <li class="is-active">
                                                <a href="${pageContext.request.contextPath}/product?page=${page1}&type=${param.type}&size=${param.size}">${page1+1}</a>
                                            </li>
                                        </c:if>
                                        <c:if test="${param.page != page1}">
                                            <li>
                                    ...
                                    <div id="js-product-detail-modal">
                                        <div>
                                            ...
                                            <img class="u-img-fluid"
                                                 src="${pageContext.request.contextPath}/resources/images/product/product-d-1.jpg"
                                                 alt=""></div>
                                        <div>

                                            <img class="u-img-fluid"
                                                 src="${pageContext.request.contextPath}/resources/images/product/product-d-2.jpg"
                                                 alt=""></div>
                                        <div>

                                            <img class="u-img-fluid"
                                                 src="${pageContext.request.contextPath}/resources/images/product/product-d-3.jpg"
                                                 alt=""></div>
                                        <div>

                                            <img class="u-img-fluid"
                                                 src="${pageContext.request.contextPath}/resources/images/product/product-d-4.jpg"
                                                 alt=""></div>
                                        <div>

                                            <img class="u-img-fluid"
                                                 src="${pageContext.request.contextPath}/resources/images/product/product-d-5.jpg"
                                                 alt=""></div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="success u-s-m-b-30">
                                ...
                                <div class="success__img-wrap">
                                    ...
                                    <img class="u-img-fluid"
                                         src="${pageContext.request.contextPath}/resources/images/product/electronic/product1.jpg"
                                         alt=""></div>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="s-option">
                                ...
                                <div class="s-option__link-box">
                                    ...
                                    <a class="s-option__link btn--e-brand-shadow" href="${pageContext.request.contextPath}/checkout/">PROCEED TO
                                        CHECKOUT</a></div>
                            </div>
                        </div>
                    </div>
...
<script>
    function changeItem(e) {
        ...
        if (e.value === "8") {
            ...
            location.href = "${pageContext.request.contextPath}/product?page=0&type=${param.type}&size=8"
        } else if (e.value === "12") {
            options[1].selected = "selected"
            location.href = "${pageContext.request.contextPath}/product?page=0&type=${param.type}&size=12"
        } else if (e.value === "16") {
            options[2].selected = "selected"
            location.href = "${pageContext.request.contextPath}/product?page=0&type=${param.type}&size=16"
        } else if (e.value === "28") {
            options[3].selected = "selected"
            location.href = "${pageContext.request.contextPath}/product?page=0&type=${param.type}&size=28"
        }
