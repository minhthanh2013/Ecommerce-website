                                    ...
                                    <ul style="width:120px">
                                        ...
                                        <form:form action="${pageContext.request.contextPath}/logout"
                                            ...
                                            <li>
                                                ...
                                                <a id="sign-out-btt" href="#"><i
                                                        class="fas fa-lock-open u-s-m-r-6 sign-out-btt-1"></i>
                                                    <span>Signout</span></a>
                    ...
                    <div class="menu-init" id="navigation2">
                        ...
                        <div class="ah-lg-mode">
                            ...
                            <ul class="ah-list ah-list--design2 ah-list--link-color-secondary">
                                ...
                                <li><a href="${pageContext.request.contextPath}/shopkeeper/sales_statistics">SALES</a>
                                </li>
                            </ul>
                            <!--====== End - List ======-->
                        </div>
                        ...
                        <div class="breadcrumb__wrap">
                            <ul class="breadcrumb__list">
                                ...
                                <li class="is-marked">
                                    ...
                                    <a href="${pageContext.request.contextPath}/shopkeeper/update_price">Update
                                        price</a></li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="dash__pad-1">
                                        ...
                                        <ul class="dash__f-list">
                                            <li>
                                                ...
                                                <a href="${pageContext.request.contextPath}/shopkeeper/edit_profile">My
                                                    Store Profile</a></li>
                                            <li>

                                                <a href="${pageContext.request.contextPath}/shopkeeper/add_product">Add
                                                    product</a></li>

                                            <li>

                                                <a class="dash-active"
                                                   href="${pageContext.request.contextPath}/shopkeeper/update_price">Update
                                                    price</a></li>
                                            <li>

                                                <a href="${pageContext.request.contextPath}/shopkeeper/order">Orders</a>
                                            </li>

                                            <li>

                                                <a href="${pageContext.request.contextPath}/shopkeeper/sales_statistics">Sales
                                                    statistics</a></li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-9 col-md-12">
                                <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                    <div class="dash__pad-2">
                                        <h1 class="dash__h1 u-s-m-b-14">Update Product's Price</h1>
                                        ...
                                        <form:form class="dash-edit-p"
                                                   action="${pageContext.request.contextPath}/shopkeeper/update_price"
                                                   modelAttribute="productAttribute1" method="POST">
                                            <div class="gl-inline">
                                                <div class="u-s-m-b-30">

                                                    <label class="gl-label" for="category-product">PRODUCT'S NAME
                                                        *</label>

                                                    <form:select class="select-box select-box--primary-style u-w-100"
                                                                 id="category-product" path="idProduct">
                                                        <c:forEach var="product" items="${productList}">
                                                            <form:option
                                                                    value="${product.idProduct}">${product.name}</form:option>
                                                        </c:forEach>
                                                    </form:select>
                                                ...
                                                <div class="u-s-m-b-30">
                                                    ...
                                                    <label class="gl-label" for="category-type">CATEGORY *</label>
                                                    <form:select class="select-box select-box--primary-style u-w-100"
                                                                 id="category-type" path="idType">
                                                        <c:forEach var="productType" items="${productTypeList}">
                                                            <form:option
                                                                    value="${productType.idType}">${productType.nameType}</form:option>
                                            ...
                                            <div class="gl-inline">
                                                <div class="u-s-m-b-30">
                                                    ...
                                                    <form:input class="input-text input-text--primary-style" type="text"
                                                                id="reg-pdescription"
                                            ...
                                            <div class="gl-inline">
                                                ...
                                                <div class="u-s-m-b-30">
                                                    ...
                                                    <label class="gl-label" for="reg-nprice">NEW PRICE *</label>
                                                    <form:input class="input-text input-text--primary-style" type="text"
                                                                id="reg-nprice" placeholder="100" path="price"/></div>
                                            </div>
                                    ...
                                    <div class="outer-footer__list-wrap">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <a href="${pageContext.request.contextPath}/dashboard/my_order">Delivery</a>
                                            </li>
                                            <li>
                ...
                <div class="modal-body">
                    <form class="d-modal__form">
                        <div class="u-s-m-b-15">
                            ...
                            <a class="d_modal__link" href="${pageContext.request.contextPath}/dashboard/edit_profile">Ludus
                                Privacy Policy</a>
                        </div>
