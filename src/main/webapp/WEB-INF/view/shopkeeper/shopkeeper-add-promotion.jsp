                                        ...
                                        <div class="dash__pad-1">
                                            ...
                                            <ul class="dash__f-list">
                                                ...
                                                <li>
                                                    ...
                                                    <a class="dash-active" href="${pageContext.request.contextPath}/shopkeeper/add_promotion">Add promotion</a></li>
                                                <li>
                                ...
                                <div class="col-lg-9 col-md-12">
                                    <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                        <div class="dash__pad-2">
                                            <h1 class="dash__h1 u-s-m-b-14">Add promotion</h1>
                                            <span class="dash__text u-s-m-b-30">Please complete your promotion!</span>
                                            ...
                                            <form class="dash-edit-p">
                                                ...
                                                <div class="gl-inline">
                                                    <div class="u-s-m-b-30">
                                                        ...
                                                        <label class="gl-label" for="reg-promotion">Promotion *</label>
                                                        <select class="select-box select-box--primary-style u-w-100" id="reg-promotion">
                                                    ...
                                                    <div class="u-s-m-b-30">
                                                        ...
                                                        <div class="gl-dob">
                                                            <select class="select-box select-box--primary-style">
                                                                ...
                                                                <option value="pro-hour-01">01</option>
                                                                <option value="pro-hour-02">02</option>
                                                                <option value="pro-hour-03">03</option>
                                                                <option value="pro-hour-04">04</option>
                                                            </select>
                                                            <select class="select-box select-box--primary-style">
                                                                <option selected>Minutes</option>
                                                                <option value="pro-min-00">00</option>
                                                                <option value="pro-min-15">15</option>
                                                                <option value="pro-min-30">30</option>
                                                                <option value="pro-min-45">45</option>
                                                            </select>
                                                            <select class="select-box select-box--primary-style">
                                                                <option selected>Day</option>
                                                                <option value="pro-day-01">01</option>
                                                                <option value="pro-day-02">02</option>
                                                                <option value="pro-day-03">03</option>
                                                                <option value="pro-day-04">04</option>
                                                            </select>
                                                            <select class="select-box select-box--primary-style">
                                                                <option selected>Month</option>
                                                                <option value="pro-month-01">01</option>
                                                                <option value="pro-month-02">02</option>
                                                                <option value="pro-month-03">03</option>
                                                                <option value="pro-month-04">04</option>
                                                            </select>
                                                            <select class="select-box select-box--primary-style">
                                                                <option selected>Year</option>
                                                                <option value="pro-year-01">01</option>
                                                                <option value="pro-year-02">02</option>
                                                                <option value="pro-year-03">03</option>
                                                                <option value="pro-year-04">04</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="gl-inline">
                                                    <table align="center" id="add-promotion-table" style="border-collapse:collapse; border: 2px double gainsboro;">
                                                        <tr align="center" class="menu-add-promotion">
                                                            <th style="padding:10px">Product's name</th>
                                                            <th style="padding:10px">Price</th>
                                                            <th style="padding:10px">Discount</th>
                                                            <th style="padding:10px">Promotion price</th>
                                                            <th style="padding:10px">Amount</th>
                                                        </tr>
                                                        <tr align="center" class="content-add-promotion">
                                                            <td style="padding:10px"><input class="input-text input-text--primary-style" type="text" placeholder="Aquafina"></td>
                                                            <td style="padding:10px"><input class="input-text input-text--primary-style" type="text" placeholder="10000"></td>
                                                            <td style="padding:10px"><input class="input-text input-text--primary-style" type="text" placeholder="50%"></td>
                                                            <td style="padding:10px"><input class="input-text input-text--primary-style" type="text" placeholder="5000"></td>
                                                            <td style="padding:10px"><input class="input-text input-text--primary-style" type="text" placeholder="20"></td>
                                                        </tr>
                                                        <tr align="center" class="content-add-promotion">
                                                            <td style="padding:10px"><input class="input-text input-text--primary-style" type="text"></td>
                                                            <td style="padding:10px"><input class="input-text input-text--primary-style" type="text"></td>
                                                            <td style="padding:10px"><input class="input-text input-text--primary-style" type="text"></td>
                                                            <td style="padding:10px"><input class="input-text input-text--primary-style" type="text"></td>
                                                            <td style="padding:10px"><input class="input-text input-text--primary-style" type="text"></td>
                        ...
                        <div class="col-lg-12">
                            <div class="lower-footer__content">
                                <div class="lower-footer__copyright">
                                    ...
                                    <a href="${pageContext.request.contextPath}/resources/">Reshop</a>
